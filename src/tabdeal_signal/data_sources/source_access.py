...
VERIFIED_SOURCE_ACCESS_SPECS: tuple[SourceAccessSpec, ...] = (
    ...
    SourceAccessSpec("ny-fed-markets-data", "Federal Reserve Bank of New York Markets Data APIs", ("008",), SourceLifecycle.DOCUMENTED, verified_hosts=("markets.newyorkfed.org", "newyorkfed.org"), adapter_scope=("public markets-data API family; route-by-route auth/availability contract pending",)),
)
