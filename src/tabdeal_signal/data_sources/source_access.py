...
VERIFIED_SOURCE_ACCESS_SPECS: tuple[SourceAccessSpec, ...] = (
    SourceAccessSpec("binance-futures-market-data", "Binance Futures Market Data", ("001",), SourceLifecycle.ADAPTER_BUILT, adapter_classes=("BinanceCoinMContinuousKlineDataSource",), verified_hosts=("dapi.binance.com", "developers.binance.com"), adapter_scope=("Coin-M public continuous-contract klines",)),
    SourceAccessSpec("bybit-futures-market-data", "Bybit Futures Market Data", ("001", "2040"), SourceLifecycle.ADAPTER_BUILT, adapter_classes=("BybitKlineDataSource", "BybitOrderbookDataSource", "BybitOpenInterestDataSource", "BybitFundingRateDataSource", "BybitTickersDataSource", "BybitInstrumentsInfoDataSource"), verified_hosts=("api.bybit.com", "bybit-exchange.github.io"), adapter_scope=("public REST kline", "public REST orderbook", "public REST open interest", "public REST funding rate history", "public REST tickers", "public REST instruments info")),
    ...
    SourceAccessSpec("binance-spot-market-data", "Binance Spot Market Data", ("002",), SourceLifecycle.ADAPTER_BUILT, adapter_classes=("BinanceSpotMarketDataSource",), verified_hosts=("data-api.binance.vision",), adapter_scope=("public Spot REST market-data JSON envelope; exact endpoint/schema runtime-configured",)),
    ...
    SourceAccessSpec("okx-market-data", "OKX Market Data", ("003",), SourceLifecycle.ADAPTER_BUILT, adapter_classes=("OkxMarketDataSource",), verified_hosts=("okx.com",), adapter_scope=("public REST market-data JSON envelope; region-specific exact endpoint runtime-configured",)),
    ...
    SourceAccessSpec("coinbase-advanced-trade-market-data", "Coinbase Advanced Trade Market Data", ("003",), SourceLifecycle.ADAPTER_BUILT, adapter_classes=("CoinbaseAdvancedTradeMarketDataSource",), verified_hosts=(), adapter_scope=("public Advanced Trade REST market-data JSON envelope; approved API host is runtime-configured; Futures/Derivatives excluded",)),
    SourceAccessSpec("deribit-market-data", "Deribit Market Data", ("003",), SourceLifecycle.ADAPTER_BUILT, adapter_classes=("DeribitPublicMarketDataSource",), verified_hosts=("www.deribit.com", "docs.deribit.com"), adapter_scope=("public JSON-RPC get_instruments/ticker/get_order_book/get_tradingview_chart_data",)),
    ...
    SourceAccessSpec("oecd-data-explorer-sdmx", "OECD Data Explorer SDMX API", ("007",), SourceLifecycle.ADAPTER_BUILT, adapter_classes=("OecdSdmxDataSource",), verified_hosts=("sdmx.oecd.org",), adapter_scope=("public SDMX text envelope; exact dataset/series runtime-configured",)),
    SourceAccessSpec("ny-fed-markets-data", "Federal Reserve Bank of New York Markets Data APIs", ("008",), SourceLifecycle.ADAPTER_BUILT, adapter_classes=("NyFedMarketsDataSource",), verified_hosts=("markets.newyorkfed.org",), adapter_scope=("public markets-data text envelope; exact route/auth/availability runtime-configured",)),
)
